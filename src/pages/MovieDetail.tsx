...
const getAvatarForName = (name: string): string => {
  const avatars = [
    ...
    'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=150&q=80', // female 1
    'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=150&q=80', // male 2
    'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=150&q=80', // female 2
    'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=150&q=80', // male 3
    'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=150&q=80', // female 3
    'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?auto=format&fit=crop&w=150&q=80', // male 4
    'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=150&q=80', // female 4
    'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=150&q=80', // male 5
    'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=150&q=80', // female 5
    'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=150&q=80', // male 6
    'https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=150&q=80', // female 6
    'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?auto=format&fit=crop&w=150&q=80', // male 7
    'https://images.unsplash.com/photo-1554151228-14d9def656e4?auto=format&fit=crop&w=150&q=80'  // female 7
  ];
  let hash = 0;
...
const getCastForContent = (item: any) => {
  ...
  if (item.cast_members && item.cast_members.length > 0) {
    return item.cast_members.map((c: any) => ({
      ...
      avatar: c.profile_path || getAvatarForName(c.name)
    }));
  }
  ...
  if (item.cast && item.cast.length > 0) {
    return item.cast.map((actorName: string) => ({
      name: actorName,
      role: 'В ролях',
      avatar: getAvatarForName(actorName)
    }));
  }

  return defaultCast.map(c => ({
    ...c,
    avatar: getAvatarForName(c.name)
  }));
};
  ...
  return (
    <div className="relative min-h-screen pb-16 pt-4 text-slate-100">
      ...
      <CastCarousel
        ...
        directorPhoto={content.directorPhoto || (content.director ? getAvatarForName(content.director) : undefined)}
        cast={cast}
